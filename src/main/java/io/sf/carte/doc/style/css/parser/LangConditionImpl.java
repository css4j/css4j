...
class LangConditionImpl extends AbstractCondition implements LangCondition {
	...
	@Override
	public LangConditionImpl clone() {
		LangConditionImpl clon = (LangConditionImpl) super.clone();
		clon.lang = lang;
		return clon;
	}
