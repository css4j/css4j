...
abstract class ValueTokenHandler extends BufferTokenHandler implements LexicalProvider {
	...
	private void handleFullStop(int index) {
		if (prevcp == 65) {
			...
			if (prevcp == 45 && functionToken && !isEscapedIdent()
