...
abstract public class ComputedCSSStyle extends BaseCSSStyleDeclaration implements CSSComputedProperties {
	...
	private StyleValue customPropertyFallback(String property, VarValue value, LexicalUnit fallback,
		...
		try {
			...
			if (custom == null) {
				...
				if (fallback != null) {
					...
					custom = inheritValue(this, propertyName, custom, true);
					if (custom != null) {
