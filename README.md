...
Building the library requires a JDK from version 11 to 25.

<br/>

## Build from source
To build css4j from the code that is currently at the Git repository, JDK from version 11 to 25 is needed.
