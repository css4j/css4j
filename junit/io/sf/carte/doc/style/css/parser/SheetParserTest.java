...
public class SheetParserTest {
	...
	public void testParseStyleSheetDefaultUserAgentSheet() throws CSSException, IOException {
		...
		assertEquals("textarea", handler.selectors.get(70).toString());
		assertEquals("hr[align=\"left\"]", handler.selectors.get(73).toString());
		assertEquals(108, handler.selectors.size());
		assertEquals(147, handler.propertyNames.size());
		assertEquals("display", handler.propertyNames.getFirst());
		assertEquals("page-break-before", handler.propertyNames.getLast());
		assertEquals(147, handler.lexicalValues.size());
		LexicalUnit lu = handler.lexicalValues.getFirst();
		assertEquals(LexicalUnit.SAC_IDENT, lu.getLexicalUnitType());
	...
	public void testParseStyleSheetDefaultUserAgentSheetQuirks() throws CSSException, IOException {
		...
		assertEquals("textarea", handler.selectors.get(71).toString());
		assertEquals("hr[align=\"left\"]", handler.selectors.get(75).toString());
		assertEquals(120, handler.selectors.size());
		assertEquals(165, handler.propertyNames.size());
		assertEquals("display", handler.propertyNames.getFirst());
		assertEquals("page-break-before", handler.propertyNames.getLast());
		assertEquals(165, handler.lexicalValues.size());
		LexicalUnit lu = handler.lexicalValues.getFirst();
		assertEquals(LexicalUnit.SAC_IDENT, lu.getLexicalUnitType());
		assertEquals("block", lu.getStringValue());
		assertNull(lu.getNextLexicalUnit());
