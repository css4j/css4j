...
public class CalcValueTest {
	...
	@Test
	public void testCreateCSSValueVar() throws IOException {
		...
		assertEquals("calc(3*2*var(--foo, 3px))", value.getCssText());
		assertEquals("calc(3*2*var(--foo,3px))", value.getMinifiedCssText(""));
	}
